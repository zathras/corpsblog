    ...
    override fun run() {
        ...
        try {
            ...
            if (c1 == 'G'.code && c2 == 'E'.code && c3 == 'T'.code && c4 == ' '.code) {
                ...
                if (h == null) {
                    h = SuccessQueryHandler("Query '$query' not implemented", rawOut!!, out!!)
                }
            } else {
                val c5 = input.read()
                if (c1 == 'P'.code && c2 == 'O'.code && c3 == 'S'.code && c4 == 'T'.code && c5 == ' '.code) {
                    ...
                    h = SuccessQueryHandler("POST probably went OK", rawOut!!, out!!)
                } else {
                    val msg = if (c5 == -1) {
                        "EOF on socket read"
                    } else {
                    ...
                    h = SuccessQueryHandler(msg, rawOut!!, out!!)
