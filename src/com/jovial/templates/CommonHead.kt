...
import com.jovial.templates.lib.Head
import com.jovial.templates.lib.Title
                 ...
                 val hasGallery: Boolean = false)
{
  public fun generate(head : Head) : Unit =  head.include {
    ...
    link(href=rootPath+"feed.xml", rel="alternate", type="application/rss+xml", title="RSS Feed")
